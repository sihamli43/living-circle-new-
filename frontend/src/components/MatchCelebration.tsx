...
const CONFETTI = [C.brand, C.coral, C.cyan, C.onSurface, "#FFFFFF"];
    ...
    <Modal visible={!!match} transparent animationType="fade" onRequestClose={onClose}>
      <View style={styles.backdrop}>
        ...
        <Animated.View style={[styles.box, boxStyle]} testID="match-modal">
          ...
          {onExploreLocations && (
            <PressableScale
              testID="match-suggest-locations"
              style={styles.ctaSecondary}
              onPress={onExploreLocations}
            >
              <Text style={styles.ctaSecondaryText}>🏘️ Explore neighborhoods together</Text>
            </PressableScale>
          )}
...
const styles = StyleSheet.create({
  ...
  ctaSecondary: {
    backgroundColor: "transparent", paddingVertical: S.md, borderRadius: R.pill,
    alignItems: "center", marginBottom: S.sm, borderWidth: 1.5, borderColor: C.border,
  },
  ctaSecondaryText: { color: C.onSurfaceSecondary, fontSize: 14, fontWeight: "700" },
});
