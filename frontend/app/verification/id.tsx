...
type VerifStatus = "idle" | "loading" | "submitted" | "error";
...
export default function IDVerificationScreen() {
  ...
  const submit = useCallback(async () => {
    ...
    try {
      ...
      setStatus("submitted");
      setResultMsg(data.message ?? "Your ID has been submitted for review. Thanks!");
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.heroCard}>
          ...
          <Text style={styles.heroSub}>
            Upload a government ID so we can confirm you're a real person. It's reviewed manually and never shown to other users.
          </Text>
        </View>
        ...
        {/* Status result */}
        {(status === "submitted" || status === "error") && resultMsg && (
          <View style={[
            styles.resultCard,
            status === "submitted" ? styles.resultSubmitted : styles.resultError,
          ]}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={styles.resultTitle}>
                {status === "submitted" ? "Submitted" : "Upload Failed"}
              </Text>
...
const styles = StyleSheet.create({
  ...
  resultSubmitted: { backgroundColor: "rgba(22,163,74,0.1)", borderColor: C.success },
  resultError:     { backgroundColor: "rgba(255,82,82,0.1)", borderColor: C.error },
  ...
  tipsCard: {
    ...
    borderWidth: 1, borderColor: "rgba(23,162,184,0.35)", padding: 18, gap: 10,
  },
  ...
  privacyCard: {
    ...
    backgroundColor: "rgba(255,82,82,0.06)", borderRadius: R.lg,
    borderWidth: 1, borderColor: "rgba(255,82,82,0.25)", padding: 16,
  },
