...
export default function OtpScreen() {
  ...
  const submit = async () => {
    ...
    try {
      ...
      if (msg.includes("Code expired")) setErr("That code expired. Go back and request a new one.");
      else if (msg.includes("already used")) setErr("That code was already used. Request a new one.");
      else if (msg.includes("Invalid code")) setErr("Incorrect code. Check and try again.");
