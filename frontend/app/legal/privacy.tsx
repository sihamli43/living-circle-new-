...
const styles = StyleSheet.create({
  ...
  noticeBanner: {
    ...
    backgroundColor: "rgba(22,163,74,0.08)", borderRadius: R.md, padding: S.md,
    borderWidth: 1, borderColor: "rgba(22,163,74,0.3)", marginBottom: S.lg,
  },
  noticeText: { flex: 1, fontSize: 13, color: C.success, lineHeight: 18 },
  section: {
