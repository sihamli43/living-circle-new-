...
const styles = StyleSheet.create({
  ...
  heroTitle: { fontSize: 22, fontWeight: "800", color: C.coral, marginBottom: S.sm },
  heroSub: { fontSize: 13, color: C.onSurfaceSecondary, marginTop: 2 },
  noticeBanner: {
    flexDirection: "row", gap: S.sm, alignItems: "flex-start",
    backgroundColor: "rgba(255,82,82,0.08)", borderRadius: R.md, padding: S.md,
    borderWidth: 1, borderColor: "rgba(255,82,82,0.3)", marginBottom: S.lg,
  },
  noticeText: { flex: 1, fontSize: 13, color: C.coral, lineHeight: 18 },
  section: {
  ...
  sectionTitle: { flex: 1, fontSize: 15, fontWeight: "700", color: C.onSurface, paddingRight: S.sm },
  sectionBody: {
  ...
  footerLink: { fontSize: 12, color: C.coral, fontWeight: "600", textDecorationLine: "underline" },
});
