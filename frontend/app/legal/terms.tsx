...
const styles = StyleSheet.create({
  ...
  noticeBanner: {
    ...
    backgroundColor: "rgba(255,0,110,0.08)", borderRadius: R.md, padding: S.md,
    borderWidth: 1, borderColor: "rgba(255,0,110,0.3)", marginBottom: S.lg,
  },
  noticeText: { flex: 1, fontSize: 13, color: "#FF99C2", lineHeight: 18 },
  section: {
